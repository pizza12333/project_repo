## 1. 구글 클라우드 플렛폼을 활용한 파이썬 데이터분석(Python Data Analysis on Google Cloud)
...
## 2. 구글 클라우드 플렛폼을 활용한 파이썬 웹 어플리케이션 개발(Google Cloud for web application)

### (1) Django + Google App Engine + Google CloudSQL을 활용한 페이스북 챗봇 아키텍쳐 구축. Part.1[바로가기]()
